...
}{Índice de Gini }{República de Guatemala, serie histórica por Encovi, adimensional}{\ \\[0mm]\begin{tikzpicture}[x=1pt,y=1pt]  \input{graficas/2_01.tex}  \end{tikzpicture}}{}
...
Al observar la participación de los quintiles en el ingreso per cápita familiar, se advierte que entre 2000 y 2014, no ha variado mucho la participación de cada quintil, ya que el quintil más bajo obtiene menos del 3\% de los ingresos y el quintil más alto capta más del 60\% de los ingresos.
}{Índice de Atkinson, con $ \varepsilon = 1$}{República de Guatemala, serie histórica por Encovi, adimensional}{\ \\[0mm]\begin{tikzpicture}[x=1pt,y=1pt]  \input{graficas/2_02.tex}  \end{tikzpicture}}{ }
...
Al observar la participación de los quintiles en el ingreso per cápita familiar, se advierte que entre 2000 y 2014, no ha variado mucho la participación de cada quintil, ya que el quintil más bajo obtiene menos del 3\% de los ingresos y el quintil más alto capta más del 60\% de los ingresos.
}{Índice de Atkinson, con $ \varepsilon = 2$}{República de Guatemala, serie histórica por Encovi, adimensional}{\ \\[0mm]\begin{tikzpicture}[x=1pt,y=1pt]  \input{graficas/2_03.tex}  \end{tikzpicture}}{}
...
Al observar la participación de los quintiles en el ingreso per cápita familiar, se advierte que entre 2000 y 2014, no ha variado mucho la participación de cada quintil, ya que el quintil más bajo obtiene menos del 3\% de los ingresos y el quintil más alto capta más del 60\% de los ingresos.
}{Índice de Theil }{República de Guatemala, serie histórica por Encovi, adimensional}{\ \\[0mm]\begin{tikzpicture}[x=1pt,y=1pt]  \input{graficas/2_04.tex}  \end{tikzpicture}}{}
...
Al observar la participación de los quintiles en el ingreso per cápita familiar, se advierte que entre 2000 y 2014, no ha variado mucho la participación de cada quintil, ya que el quintil más bajo obtiene menos del 3\% de los ingresos y el quintil más alto capta más del 60\% de los ingresos.
}{Proporción del primer quintil de ingresos respecto del ingreso total}{República de Guatemala, serie histórica por Encovi, en porcentaje}{\ \\[0mm]\begin{tikzpicture}[x=1pt,y=1pt]  \input{graficas/2_05.tex}  \end{tikzpicture}}{}
...
Al observar la participación de los quintiles en el ingreso per cápita familiar, se advierte que entre 2000 y 2014, no ha variado mucho la participación de cada quintil, ya que el quintil más bajo obtiene menos del 3\% de los ingresos y el quintil más alto capta más del 60\% de los ingresos.
}{Proporción del quinto quintil de ingresos respecto del ingreso total}{República de Guatemala, serie histórica por Encovi, en porcentaje}{\ \\[0mm]\begin{tikzpicture}[x=1pt,y=1pt]  \input{graficas/2_06.tex}  \end{tikzpicture}}{}
